...
class Api(vnokcoin.OkCoinApi):
    ...
    def onOpen(self, ws):       
        ...
        if self.currency == vnokcoin.CURRENCY_USD:
            ...
            self.subscribeFutureTicker(vnokcoin.SYMBOL_BTC, vnokcoin.FUTURE_EXPIRY_THIS_WEEK)
            self.subscribeFutureTicker(vnokcoin.SYMBOL_BTC, vnokcoin.FUTURE_EXPIRY_NEXT_WEEK)
            self.subscribeFutureTicker(vnokcoin.SYMBOL_BTC, vnokcoin.FUTURE_EXPIRY_QUARTER)
            
            self.subscribeFutureDepth(vnokcoin.SYMBOL_BTC, vnokcoin.FUTURE_EXPIRY_THIS_WEEK, vnokcoin.DEPTH_20)
            self.subscribeFutureDepth(vnokcoin.SYMBOL_BTC, vnokcoin.FUTURE_EXPIRY_NEXT_WEEK, vnokcoin.DEPTH_20)
            self.subscribeFutureDepth(vnokcoin.SYMBOL_BTC, vnokcoin.FUTURE_EXPIRY_QUARTER, vnokcoin.DEPTH_20)
    ...
    def initCallback(self):
        ...
        # USD_FUTURES
        self.cbDict['ok_sub_futureusd_btc_ticker_this_week'] = self.onTicker
